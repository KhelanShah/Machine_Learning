...
# reading datasets
train_data = pd.read_csv('/home/ubuntu/train.csv')
test_data = pd.read_csv('/home/ubuntu/titanic_test.csv')
validation_data = pd.read_csv('/home/ubuntu/titanic_validation.csv')
...
joblib.dump(model,'/home/ubuntu/Logistic_regression.pk1')

import os
os.system("touch /home/ubuntu/accuracy.txt")
os.system("echo {} > /home/ubuntu/accuracy.txt".format(accuracy))
